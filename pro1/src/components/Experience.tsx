...
import { Calendar, MapPin, Shield, Cloud, FileText, Search, Zap, Database } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          {[
            ...
            { number: '5', label: 'Fortune 500 Companies', icon: Shield },
            { number: '100+', label: 'Security Assessments', icon: Search },
          ].map((stat, index) => (
            <motion.div
              key={index}
